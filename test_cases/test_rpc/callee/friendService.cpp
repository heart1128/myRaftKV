 ...
 * @LastEditTime: 2024-05-09 20:55:34
 * @FilePath: /myRaftKv/test_cases/test_rpc/callee/friendService.cpp
 * @Description: 
 */
//
...
class FriendService : public fixbug::FiendServiceRpc {
 public:
  ...
  void GetFriendsList(::google::protobuf::RpcController *controller, const ::fixbug::GetFriendsListRequest *request,
                      ::fixbug::GetFriendsListResponse *response, ::google::protobuf::Closure *done) override{
...
int main(int argc, char **argv) {
  ...
  short port = 7788;
  auto stub = new fixbug::FiendServiceRpc_Stub(new RpcChannel(ip, port, false));
